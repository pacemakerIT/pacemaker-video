...
export default function CourseHero({
  // default values are for /courses page
  tag = 'WITH PACEMAKER',
  title = 'Build a strong foundation',
  titleLine2 = 'for your career abroad',
  ...
  return (
    <section
      id="main-content"
      className="w-screen relative flex min-h-[370px] flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-[#e6f0f8] to-white px-4 py-8 text-center md:h-[370px] md:py-0"
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 flex flex-col items-center">
        <p className="mb-2 text-base font-bold uppercase tracking-[0.16em] text-orange">
          {tag}
        </p>
        <h1 className="mb-8 max-w-[800px] px-4 font-headline text-[32px] font-extrabold leading-tight text-navy md:text-[40px]">
          {title}
          {titleLine2 && (
            <>
