  ...
  return (
    <>
      <div className="w-full mb-8">
        <p className="text-[#FF4F02] font-bold text-[18px] tracking-wide mb-2">
      ...
      <div className="w-full flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between mb-8">
          ...
          {category.map((categoryName) => {
            ...
            return (
              <button
                ...
                className="inline-flex items-center justify-center min-w-[110px] px-6 py-3 border border-[#d0d5dd] rounded-2xl bg-white text-[#667085] text-base font-medium font-headline transition-all duration-300 hover:border-current cursor-pointer"
                onMouseEnter={(e) => {
                  if (!isActive) {
        ...
        <Select value={sortBy} onValueChange={(value) => setSortBy(value)}>
          <SelectTrigger className="w-[180px] h-12 text-[#667085] bg-white rounded-2xl border-[#eaecf0] shadow-[0_4px_12px_rgba(0,38,59,0.08)]">
