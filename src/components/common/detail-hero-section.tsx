    ...
    <div className="w-full flex justify-between items-center h-[600px] relative overflow-hidden">
      ...
      <div className="w-[62.5%] min-w-[1200px] items-center mx-auto justify-center flex gap-8">
        ...
        <div className="w-[40%] flex justify-center items-center px-8 relative z-10 ">
          {isCourse ? (
            <div className="flex flex-col bg-white rounded-none p-7 shadow-[0_10px_30px_rgba(0,38,59,0.08)] w-full max-w-[360px] min-h-[382px] justify-between gap-4 border border-gray-100">
              <div>
                <h2 className="text-[1.5rem] font-bold text-[#00263b] leading-tight mb-4">
                  {title}
                </h2>
              ...
              <div className="mt-auto">
                <div className="flex justify-between items-center pt-3 border-t border-gray-100 mb-5">
                  ...
                  <span className="text-2xl font-bold text-[#00263b]">
                    $
                    {typeof price === 'number'
                ...
                <div className="flex gap-3 items-center">
                  <Button
                    className="flex-1 bg-[#ff4f02] text-white font-bold py-4 px-8 rounded-2xl shadow-[0_10px_25px_-5px_rgba(255,79,2,0.3)] hover:bg-[#e04400] hover:scale-[1.02] transition-all text-lg"
