...
const ReviewContainer = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#F2F4F7] py-16 flex flex-col items-center">
          ...
          {[...Array(3)].map((_, idx) =>
            reviews.map((review) => (
              ...
              >
                ...
                <div className="text-sm text-[#475467] break-words whitespace-pre-line line-clamp-4">
                  {review.content}
                </div>
              </div>
            ))
