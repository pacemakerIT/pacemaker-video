        ...
        <div className="w-full bg-white border border-gray-100 shadow-[0_10px_30px_rgba(0,38,59,0.08)] overflow-hidden rounded-none flex flex-col pm-card-lift dark:bg-gray-950">
          ...
          <div className="p-6 space-y-4 flex-grow">
            <div className="flex justify-between items-start gap-4">
              <h3 className="text-lg font-bold text-[#00263B] leading-tight font-headline">
                {displayTitle}
              </h3>
              <span className="text-xl font-extrabold text-[#00263B] shrink-0">{`$${
                typeof price === 'number'
            ...
            <p className="text-sm leading-relaxed line-clamp-2 text-[#667085]">
              {description}
            </p>

            <div className="inline-flex items-center gap-1 text-pace-teal-500 font-bold text-sm hover:translate-x-1 transition-transform duration-300 ease-out mt-2">
              Learn more
